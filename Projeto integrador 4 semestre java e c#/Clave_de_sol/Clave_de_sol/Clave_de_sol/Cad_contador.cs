...
{
    public partial class Cad_contador : Form
    {
        ...
        public void carregaDados()
        {
            try
            {
                ...
                if (txtBuscar.Text == "")
                {
                    cmd.CommandText = "SELECT * FROM contador";
                }
                else
                {
                    cmd.CommandText = "SELECT * FROM contador  WHERE cod_cont LIKE '" + txtBuscar.Text + "%'";
                }
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                cmd.CommandText = "INSERT INTO contador(nome,cnpj,ie,logradouro,numero,cep,complemento,telefone,celular)VALUES('" + txtNome.Text + "','" + txtCnpj.Text + "','" + txtIe.Text + "','" + txtLogradouro.Text + "','" + txtNumero.Text + "','" + txtCep.Text + "','" + txtComplemento.Text + "','" + txtTelefone.Text + "','" + txtCelular.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Dispose();
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            try
            {
                cmd.CommandText = "UPDATE contador SET nome='" + txtNome.Text + "', cnpj='" + txtCnpj.Text + "', ie='" + txtIe.Text + "', logradouro='" + txtLogradouro.Text + "', numero='" + txtNumero.Text + "', cep='" + txtCep.Text + "', complemento='" + txtComplemento.Text + "' , telefone='" + txtTelefone.Text + "', celular='" + txtCelular.Text + "' WHERE cod_cont='" + listView1.Items[listView1.FocusedItem.Index].SubItems[0].Text + "'";
                cmd.ExecuteNonQuery();
        ...
        private void btnExluir_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd.CommandText = "DELETE FROM contador WHERE cod_cont='" + listView1.Items[listView1.FocusedItem.Index].SubItems[0].Text + "'";
                cmd.ExecuteNonQuery();
        ...
        private void Cad_contador_Load(object sender, EventArgs e)
        {
