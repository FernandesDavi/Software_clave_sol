    ...
    public partial class Cad_Func : Form
    {
        ...
        public void carregaDados()
        {
            try
            {
                ...
                {
                    cmd.CommandText = "SELECT * FROM funcionario WHERE nome LIKE '" + txtBuscar.Text + "%'";
                }
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                cmd.CommandText = "INSERT INTO funcionario(nome,cpf,rg,dtnasc,logradouro,numero,cep,complemento,telefone,celular)VALUES('" + txtNome.Text + "','" + txtCpf.Text + "','" + txtRg.Text + "','" + txtDtnasc.Text + "','" + txtLogradouro.Text + "','" + txtNumero.Text + "','" + txtCep.Text + "','" + txtComplemento.Text + "','" + txtTelefone.Text + "','" + txtCelular.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Dispose();
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            try
            {
                cmd.CommandText = "UPDATE funcionario SET nome='" + txtNome.Text + "', cpf='" + txtCpf.Text + "', rg='" + txtRg.Text + "', dtnasc='" + txtDtnasc.Text + "', logradouro='" + txtLogradouro.Text + "', numero='" + txtNumero.Text + "', cep='" + txtCep.Text + "', complemento='" + txtComplemento.Text + "' , telefone='" + txtTelefone.Text + "', celular='" + txtCelular.Text + "' WHERE cod_func='" + listView1.Items[listView1.FocusedItem.Index].SubItems[0].Text + "'";
                cmd.ExecuteNonQuery();
        ...
        private void btnExluir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cmd.CommandText = "DELETE FROM funcionario WHERE cod_func='" + listView1.Items[listView1.FocusedItem.Index].SubItems[0].Text + "'";
                    cmd.ExecuteNonQuery();
