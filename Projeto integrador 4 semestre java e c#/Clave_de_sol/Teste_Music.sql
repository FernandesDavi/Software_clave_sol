...
-- select para somar os valores da tabela caixa de entrada de valores (vendas) à vista
select SUM(valor) as x from caixa where status = 0 AND cod_comp is null;  

-- select para somar os valores da tabela caixa de entrada de valores (vendas) à Prazo

select SUM(valor) as y from caixa where status = 1 AND cod_comp is null;
-- select para somar os valores da tabela caixa de saida de valores(Compras) à Vista

select SUM(valor) as x from caixa where status = 0 AND cod_venda is null;  
-- select para somar os valores da tabela caixa de saida de valores(Compras) à Prazo

select SUM(valor) as y from caixa where status = 1 AND cod_venda is null;  


select * from caixa where  cod_venda = 0;




select * from caixa where data_hora = CURRENT_DATE(); 
-- SELECT EXTRACT(DAY FROM data_hora) AS DIA, EXTRACT(MONTH FROM data_hora) AS MES, EXTRACT(YEAR FROM data_hora) as ano from caixa ;

--  entrada

-- Venda
-- dia
SELECT EXTRACT(DAY FROM data_hora) AS DIA , SUM(valor) as x from caixa where status = 0 AND cod_comp is null and EXTRACT(DAY FROM data_hora) = EXTRACT(DAY FROM CURRENT_DATE);
-- mes
SELECT EXTRACT(month FROM data_hora) AS mes , SUM(valor) as x from caixa where status = 0 AND cod_comp is null and EXTRACT(month FROM data_hora) = EXTRACT(month FROM CURRENT_DATE);
-- ano
SELECT EXTRACT(year FROM data_hora) AS ano , SUM(valor) as x from caixa where status = 0 AND cod_comp is null and EXTRACT(year FROM data_hora) = EXTRACT(year FROM CURRENT_DATE);


--  saida
-- dia
SELECT EXTRACT(DAY FROM data_hora) AS DIA , SUM(valor) as y from caixa where status = 1 AND cod_comp is null and EXTRACT(DAY FROM data_hora) = EXTRACT(DAY FROM CURRENT_DATE);
-- mes
SELECT EXTRACT(month FROM data_hora) AS mes , SUM(valor) as y from caixa where status = 1 AND cod_comp is null and EXTRACT(month FROM data_hora) = EXTRACT(month FROM CURRENT_DATE);
-- ano
SELECT EXTRACT(year FROM data_hora) AS ano , SUM(valor) as y from caixa where status = 1 AND cod_comp is null and EXTRACT(year FROM data_hora) = EXTRACT(year FROM CURRENT_DATE);



-- Compras
-- dia
SELECT EXTRACT(DAY FROM data_hora) AS DIA , SUM(valor) as x from caixa where status = 0 AND cod_venda is null and EXTRACT(DAY FROM data_hora) = EXTRACT(DAY FROM CURRENT_DATE);
-- mes
SELECT EXTRACT(month FROM data_hora) AS mes , SUM(valor) as x from caixa where status = 0 AND cod_venda is null and EXTRACT(month FROM data_hora) = EXTRACT(month FROM CURRENT_DATE);
-- ano
SELECT EXTRACT(year FROM data_hora) AS ano , SUM(valor) as x from caixa where status = 0 AND cod_venda is null and EXTRACT(year FROM data_hora) = EXTRACT(year FROM CURRENT_DATE);


--  saida
-- dia
SELECT EXTRACT(DAY FROM data_hora) AS DIA , SUM(valor) as y from caixa where status = 1 AND cod_venda is null and EXTRACT(DAY FROM data_hora) = EXTRACT(DAY FROM CURRENT_DATE);
-- mes
SELECT EXTRACT(month FROM data_hora) AS mes , SUM(valor) as y from caixa where status = 1 AND cod_venda is null and EXTRACT(month FROM data_hora) = EXTRACT(month FROM CURRENT_DATE);
-- ano
SELECT EXTRACT(year FROM data_hora) AS ano , SUM(valor) as y from caixa where status = 1 AND cod_venda is null and EXTRACT(year FROM data_hora) = EXTRACT(year FROM CURRENT_DATE);
