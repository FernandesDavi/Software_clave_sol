 ...
 * @author aluno
 */
public class Form_Rel_Func extends javax.swing.JFrame {

    /**
     * Creates new form Form_Rel_Func
     */
    ...
    public void criaGrafico() {
        ...
        String titulo = "Total de Funcionário";
    ...
    public Form_Rel_Func() {
        initComponents();
        createDataset();
        criaGrafico();
    }

    public Form_Rel_Func(LoginTO lto,String nivelAcesso) {
        initComponents();
        createDataset();
        criaGrafico();
        lTO = lto;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Rel_Func.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_Rel_Func().setVisible(true);
            }
        });
    }
